<#
    ...
    for giving me the framework to build this
...
#Insatlls Mandiant-AzureAD-Investigator
Write-Host "`Mandiant-AzureAD-Investigator" -ForegroundColor Cyan
git clone https://github.com/mandiant/Mandiant-Azure-AD-Investigator.git
Start-Sleep -Milliseconds 500
Write-Host "`t[+] Mandiant-AzureAD-Investigator" -ForegroundColor Green
